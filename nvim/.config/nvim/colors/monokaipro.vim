...
let s:white       = { "gui": "#fcfcfa", "cterm": "252" } " done
let s:black       = { "gui": "#2d2a2e", "cterm": "234" } " done
...
let s:warmgrey    = { "gui": "#727072", "cterm": "59" }  " done

let s:pink        = { "gui": "#FC6389", "cterm": "197" } " done
let s:green       = { "gui": "#aada7b", "cterm": "148" } " done
let s:aqua        = { "gui": "#7cdce7", "cterm": "81" }  " done
let s:yellow      = { "gui": "#fed76f", "cterm": "186" } " done
let s:orange      = { "gui": "#fa986c", "cterm": "208" } " done
let s:purple      = { "gui": "#ab9fef", "cterm": "141" } " done
...
call s:h("MatchParen",    { "fg": s:pink,      "bg": s:black, "format": "underline" })
